...
public class ajouter implements ActionListener {
	...
	//interface ajouter
public ajouter(String nom,String prenom,String mail,int idchauffeur) {
	chauffeur1=new chauffeur(nom,prenom,mail,idchauffeur);

	cadre	=	new	JFrame();
	cadre.setTitle ("ajout");
...
public void actionPerformed(ActionEvent arg0) {
		chauffeur1.add(Integer.parseInt(idtrajet.getText()) ,depart.getText(), arriver.getText(), datedepart.getText(), datearriver.getText(), Double.parseDouble(poids.getText()), Integer.parseInt(prix.getText()), Integer.parseInt(statue.getText()));
		cadre.dispose();
}
}
